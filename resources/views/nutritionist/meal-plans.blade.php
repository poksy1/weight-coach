            ...
            <div class="col-span-3 space-y-5">
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 h-[210px]">
                    ...
                    <div class="flex items-end gap-2 mt-2">
                        ...
                        <span class="text-4xl font-black text-emerald-800">
                            2400
                        </span>
                    ...
                    <div class="grid grid-cols-3 gap-2 mt-5 text-center text-xs">
                        ...
                        <div>
                            ...
                            <p class="bg-blue-50 text-blue-600 py-2 rounded-lg font-bold">
                                30%
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="bg-yellow-50 text-yellow-600 py-2 rounded-lg font-bold">
                                45%
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="bg-red-50 text-red-600 py-2 rounded-lg font-bold">
                                25%
                            </p>
                        </div>
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 h-[455px]">
                    ...
                    <h3 class="font-black text-emerald-900 mb-4">
                        Daftar Resep
                    </h3>
                    ...
                    <div class="flex gap-2 mt-4 text-xs">
                        ...
                        <span class="bg-emerald-700 text-white px-3 py-1 rounded-full">
                            Protein Tinggi
                        </span>
                ...
                <div class="grid grid-cols-3 gap-5 p-5">
                    ...
                    <div>
                        ...
                        <div class="border border-dashed border-slate-300 rounded-lg p-3 mb-3 bg-slate-50 min-h-[90px]">
                            ...
                            <p class="font-black text-sm mt-1">
                                Oat Pisang
                            </p>
                    ...
                    <div>
                        ...
                        <div class="border border-dashed border-slate-300 rounded-lg h-[90px] flex items-center justify-center text-2xl text-slate-300 mb-3">
                            +
                        </div>
                        ...
                        <div class="border border-dashed border-slate-300 rounded-lg h-[110px] flex items-center justify-center text-2xl text-slate-300">
                            +
                        </div>
...
<div class="col-span-3 space-y-5">
    ...
    <!-- MAKRO REAL TIME -->
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 h-[430px]">

        <h3 class="font-black text-emerald-900 mb-8">
            Makro Real-time
        </h3>

        <div class="w-44 h-44 mx-auto rounded-full border-[14px] border-emerald-700 flex items-center justify-center bg-white">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
        ...
        <div class="space-y-3 text-sm">
            ...
            <p class="flex items-start gap-2">
                <span>✅</span>
                <span>Target protein tinggi terpenuhi</span>
            </p>

            <p class="flex items-start gap-2 text-slate-500">
                <span>ⓘ</span>
                <span>Tambahkan 15g lemak untuk mencapai target</span>
            </p>
